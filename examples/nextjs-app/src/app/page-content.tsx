      ...
      <div className="max-w-4xl mx-auto py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {demos.map((demo) => (
            ...
            >
              <h2 className="text-2xl font-semibold mb-3 text-primary-dark">
                {demo.title}
              </h2>
              ...
              <div className="mt-4">
                <Link
                  href={demo.path}
                  className="inline-block px-4 py-2 bg-primary-medium text-white rounded-lg hover:bg-primary-dark transition-colors"
                >
                  Try Demo
                </Link>
              </div>
