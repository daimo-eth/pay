...
contract RelayerTest is Test {
    ...
    function testCheckSwapAndTipHash() public view {
        ...
        bytes32 EXPECTED_SWAP_AND_TIP_HASH = 0x7c7d33efab0e3c638739998f7dec0c5f0cdfbeef9e7c70ed470e3a955e101089;
        assertEq(keccak256(abi.encode(params)), EXPECTED_SWAP_AND_TIP_HASH);
    }
