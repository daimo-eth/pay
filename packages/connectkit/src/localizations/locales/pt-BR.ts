...
const ptBR: LocaleProps = {
  ...
  payWithAnotherWallet: "Pagar com outra carteira",
  payWithAnotherMethod: "Pagar com outro método",
  payWithExchange: "Pagar via exchange",
  payViaPaymentApp: "Pagar via app de pagamento",
  payToAddress: "Pagar para o endereço",
  retry: "Tentar novamente",
  invalidState_heading: "Estado inválido",
  invalidState_description:
    "Nenhum conector corresponde ao ID fornecido. Este estado não deveria ocorrer.",
  ...
  mobile: "Celular",
  poweredBy: "Oferecido por",
  scanWithPhone: "Escanear com o celular",
  selectExchange: "Selecionar exchange",
  solanaWallet: "Carteira Solana",
  leaveSession: "Sair da sessão?",
  leaveConfirm_description:
    "Deseja encerrar seu endereço USDT TRC-20 na TRON? Ao fazer isso, sua sessão atual será encerrada e você precisará iniciar uma nova.",
  leaveConfirm_stay: "Ficar",
  leaveConfirm_leave: "Encerrar sessão",
  selectChain: "Selecionar rede",
  selectApp: "Selecionar app",
  selectAmount: "Selecionar valor",
  paymentSuccessful: "Pagamento concluído",
  error: "Erro",
  retryPayment: "Tentar pagar novamente",
